...
|------|------|---------|
| **Go** | **52.6 ms** | 1x (基准) |
| Python | 2,739 ms | 慢 52 倍 |
| Xxlang | 6,227 ms | 慢 118 倍 |
...
|------|------|---------|
| **Go** | **4.7 ms** | 1x (基准) |
| Python | 248 ms | 慢 53 倍 |
| Xxlang | 570 ms | 慢 121 倍 |
...
**关键发现**：算法选择比语言更重要。使用 TCO，Xxlang 实现了 **400,000 倍** 的性能提升，甚至可以匹配或超越 Go 的迭代实现。
